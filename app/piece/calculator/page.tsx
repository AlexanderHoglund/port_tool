  ...
  const loadTypicalValues = useCallback(() => {
    ...
    const portConfigs: Record<string, PortDef> = {
      ...
      regional: {
        terminals: [
          {
            name: 'Container Terminal', type: 'container', teu: 500000,
            berths: [
        ...
        terminals: [
          ...
          },
          {
            ...
            berths: [
              ...
              { segment: 'roro_7k_plus', calls: 60, hours: 20 },
            ],
            equipment: {},
            cableLength: 500,
          },
      ...
      mega_hub: {
        terminals: [
          {
            name: 'Automated Container Terminal', type: 'container', teu: 2000000,
            berths: [
          ...
          {
            name: 'Conventional Container Terminal', type: 'container', teu: 1200000,
            berths: [
          ...
          },
          {
            ...
            berths: [
              ...
              { segment: 'roro_7k_plus', calls: 120, hours: 20 },
            ],
            equipment: {},
            cableLength: 600,
          },
          {
            ...
            berths: [
              ...
              { segment: 'cruise_175k_plus', calls: 40, hours: 14 },
            ],
            equipment: {},
            cableLength: 400,
          },
                    ...
                    <div className="mt-8 flex justify-center">
                      ...
                      {!isBaselineComplete && (
                        <p className="ml-4 self-center text-xs text-[#8c8c8c]">
                          Configure at least one terminal with throughput and equipment or vessel calls
                        </p>
                      )}
                    </div>
                  </>
